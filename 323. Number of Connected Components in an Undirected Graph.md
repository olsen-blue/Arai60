...
class Solution:
    def countComponents(self, n: int, edges: List[List[int]]) -> int:
        ...
        return num_connected_nodes
```
# Step4：レビューコメントをもとに、さらに修正           
- 隣接リストの変数名について、「adjacency_list」が良さそう。 
    - https://github.com/olsen-blue/Arai60/pull/19/files#r1918641102
- 関数名については、「traverse()」が良さそうな感じ。
    - https://github.com/olsen-blue/Arai60/pull/19/files#r1918645802
    - https://e-words.jp/w/%E3%83%88%E3%83%A9%E3%83%90%E3%83%BC%E3%82%B5%E3%83%AB.html#google_vignette
- まだ、変数名・関数名を略してしまう癖があるので、古スペルで文字を削らず書くことを徹底したい。
- 短く書くのは実装時に楽をしているだけで、長い目で見ると、読み手の余計な認知負荷を多く発生させる、と理解...
    - https://github.com/olsen-blue/Arai60/pull/19/files#r1918643334
